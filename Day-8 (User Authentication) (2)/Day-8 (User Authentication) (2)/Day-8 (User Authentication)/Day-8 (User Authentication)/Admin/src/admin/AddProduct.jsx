...
const AddProduct = () => {
  ...
  const uploadToCloudinary = async (file) => {
    ...
    formData.append("upload_preset", "myProjectPreset"); // Replace with your Cloudinary upload preset
    formData.append("cloud_name", "drnll4as8"); // Replace with your Cloudinary cloud name
